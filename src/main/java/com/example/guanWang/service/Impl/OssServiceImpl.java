...
import com.example.guanWang.api.config.AliOSSConfig;
import com.example.guanWang.dto.OssCallbackParam;
...
public class OssServiceImpl implements OssService {
	...
	public OssTokenVO getToken() throws ClientException {
		DefaultProfile defaultProfile = DefaultProfile.getProfile(aliOSSConfig.getRegionId(), aliOSSConfig.getAccessKeyId(),
				aliOSSConfig.getAccessKeySecret());
		DefaultAcsClient client = new DefaultAcsClient(defaultProfile);
		AssumeRoleRequest request = new AssumeRoleRequest();
		request.setRoleSessionName("Wang");
		...
		return OssTokenVO.builder()
				...
				.bucket(aliOSSConfig.getBucketName())
				.build();
	}
}
